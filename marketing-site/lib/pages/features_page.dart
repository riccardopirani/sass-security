...
class FeaturesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sections = <({IconData icon, String title, String subtitle, Widget? trailing})>[
      (
        ...
        SectionContainer(
          ...
          child: Wrap(
            ...
            children: List.generate(sections.length, (index) {
              ...
              return SizedBox(
                width: MediaQuery.sizeOf(context).width < 920 ? double.infinity : 380,
                child: GlassCard(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
